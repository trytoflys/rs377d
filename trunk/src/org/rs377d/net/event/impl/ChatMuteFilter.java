...
public class ChatMuteFilter implements EventListener
{
	...
	public void handle(IoSession session, Rs2Packet packet, EventListenerChain chain) throws Exception
	{
		...
		if ((Boolean) player.getAttribute("muted"))
			player.getActionSender().sendMessage("You are muted, and cannot chat.");
		else
