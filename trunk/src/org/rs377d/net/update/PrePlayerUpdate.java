...
public class PrePlayerUpdate implements Runnable
{

	private final PlayerUpdateCoordinator coordinator;
	private final Player player;

	public PrePlayerUpdate(PlayerUpdateCoordinator coordinator, Player player)
	{
	...
	public void run()
	{
		player.getWalkingManager().processNextMovement();
